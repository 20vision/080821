...
export default function PaperPreview({setSelectedComponent}){
  ...
  useEffect(async() => {
      ...
      axios.get(`https://http-server-vkp2ityhga-ew.a.run.app/get/component/${components[highlightIndex].uid}/subs`)
      .then(response => {
          setComponents([
  ...
  const getComponents = async() => {
      ...
      try{
          let components_data = (await axios.get(`https://http-server-vkp2ityhga-ew.a.run.app/get/page/${router.query.page?router.query.page+'/':''}components/${components.length}${router.query.mission?'/'+router.query.mission:null}`)).data
