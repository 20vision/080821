...
export default function CreateMission({type}) {
        ...
        if(Title.length < 2){
            ...
            setTimer(setTimeout(() => {
                if(Title.length < 4){
                    ...
                    axios.get(`https://http-server-vkp2ityhga-ew.a.run.app/get/${type=='mission'?'mission_title_unique':type=='topic'?'topic_title_unique':null}/${router.query.page}/${Title}`,{
    ...
    function addMission(){
        setLoading(true)
        axios.post(`https://http-server-vkp2ityhga-ew.a.run.app/post/mission`,{pagename: router.query.page, missionTitle: Title, missionBody: Body},{
        withCredentials: true
        }).then(response => {
    ...
    function addTopic(){
        setLoading(true)
        axios.post(`https://http-server-vkp2ityhga-ew.a.run.app/post/topic`,{pagename: router.query.index[0], topicTitle: Title, topicBody: Body, topicThreshold: topicTokenThreshold},{
        withCredentials: true
        }).then(response => {
