...
CREATE TABLE `ForumPost` (
  ...
  UNIQUE KEY `Sub_Forum_Post_Nested_Set_Left_UN` (`left`,`forumpost_parent_id`),
  UNIQUE KEY `Sub_Forum_Post_Nested_Set_Right_UN` (`right`,`forumpost_parent_id`),
...
-- Dump completed on 2021-12-29  1:17:41
