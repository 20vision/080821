...
CREATE TABLE `Forum_Post_Like` (
  ...
  KEY `Forum_Post_Like_FK` (`user_id`),
...
--
-- Table structure for table `Main_Forum_Post_Adjacency_List`
--

DROP TABLE IF EXISTS `Main_Forum_Post_Adjacency_List`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `Main_Forum_Post_Adjacency_List` (
  `main_forum_post_adjacency_list_id` int NOT NULL AUTO_INCREMENT,
  `parent_id` int NOT NULL,
  `parent_type` tinyint(1) NOT NULL,
  `message` varchar(280) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL,
  `user_id` int NOT NULL,
  `hex_color` varchar(6) NOT NULL,
  `user_token_impact_per_1_billion` int NOT NULL DEFAULT '0',
  `created` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
  PRIMARY KEY (`main_forum_post_adjacency_list_id`),
  KEY `Forum_Post_FK` (`user_id`),
  CONSTRAINT `Forum_Post_FK` FOREIGN KEY (`user_id`) REFERENCES `User` (`user_id`)
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `Main_Forum_Post_Adjacency_List`
--

LOCK TABLES `Main_Forum_Post_Adjacency_List` WRITE;
/*!40000 ALTER TABLE `Main_Forum_Post_Adjacency_List` DISABLE KEYS */;
/*!40000 ALTER TABLE `Main_Forum_Post_Adjacency_List` ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `Paper` VALUES (22,'1639539158678',16,1),(23,'1640354314129',16,1);
...
INSERT INTO `Paper_Media` VALUES (19,'paper_images/1639539158678/gHiZY7ax/',20),(20,'paper_images/1640354314129/wqZPRbh4/',21);
...
INSERT INTO `Paper_Version` VALUES (20,22,'0.0.0',NULL,'2021-12-15 03:32:40'),(21,23,'0.0.0',NULL,'2021-12-24 13:58:36');
...
--
-- Table structure for table `Sub_Forum_Post_Nested_Set`
--

DROP TABLE IF EXISTS `Sub_Forum_Post_Nested_Set`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `Sub_Forum_Post_Nested_Set` (
  `sub_forum_post_nested_set_id` int NOT NULL AUTO_INCREMENT,
  `main_forum_post_adjacency_list_id` int NOT NULL,
  `right` int NOT NULL,
  `left` int NOT NULL,
  `message` varchar(280) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL,
  `user_id` int NOT NULL,
  ...
  `created` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
  PRIMARY KEY (`sub_forum_post_nested_set_id`),
  UNIQUE KEY `Sub_Forum_Post_Nested_Set_Left_UN` (`left`,`main_forum_post_adjacency_list_id`),
  UNIQUE KEY `Sub_Forum_Post_Nested_Set_Right_UN` (`right`,`main_forum_post_adjacency_list_id`),
  KEY `Forum_Post_FK` (`user_id`) USING BTREE,
  KEY `Forum_Post_main` (`main_forum_post_adjacency_list_id`) USING BTREE,
  CONSTRAINT `Forum_Post_FK_copy` FOREIGN KEY (`user_id`) REFERENCES `User` (`user_id`) ON DELETE RESTRICT ON UPDATE RESTRICT,
  CONSTRAINT `Sub_Forum_Post_Nested_Set_FK` FOREIGN KEY (`main_forum_post_adjacency_list_id`) REFERENCES `Main_Forum_Post_Adjacency_List` (`main_forum_post_adjacency_list_id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `Sub_Forum_Post_Nested_Set`
--

LOCK TABLES `Sub_Forum_Post_Nested_Set` WRITE;
/*!40000 ALTER TABLE `Sub_Forum_Post_Nested_Set` DISABLE KEYS */;
/*!40000 ALTER TABLE `Sub_Forum_Post_Nested_Set` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2021-12-28 21:27:27
